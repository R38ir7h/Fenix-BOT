    ...
    let editorHolder = document.querySelector('.editorHolder'),
        ...
        toRGB = (hex, reversed, integer) => {
            ...
            embed: {
                ...
                url: "https://fw-rebirth.com",
                author: {
                    name: "Просто заголовок",
                    url: "https://fw-rebirth.com",
                    icon_url: "https://fw-rebirth.com/images/logo/icon.png"
                },
                thumbnail: {
                    url: "https://fw-rebirth.com/images/logo/icon.png"
                },
                image: {
                    url: "https://fw-rebirth.com/images/logo/mini_logo.png"
                },
                footer: {
                    text: "Copyright © 2017-2022 Сообщество fw-rebirth.com",
                    icon_url: "https://fw-rebirth.com/images/logo/icon.png"
                },
                fields: [
                    {
