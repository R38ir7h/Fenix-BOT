...
channel.send(embed)
 ...
 app.get("/redeem", checkAuth, (req, res) => {
    ...
    app.get("/dashboard", checkAuth, (req, res) => {
      ...
      const server = client.guilds.cache.get('944005578349490216');
      ...
      if (Object.prototype.hasOwnProperty.call(data, "sendEmbed")) {
        ...
        if (ticketSettings.ticketToggle == "true") {
          ...
          if (ticketSettings.ticketType == "reaction" && ticketSettings.ticketCustom == "false") {
            ...
            if (storedSettings.isPremium == "false") {
              ticketSettings.ticketFooter = "© 2017-2022 Сообщество fw-rebirth.com";
            } else {
            ...
            let reactionFooter = "© 2017-2022 Сообщество fw-rebirth.com";



            let footer = "© 2017-2022 Сообщество fw-rebirth.com";
            ...
            if (storedSettings.isPremium == "false") {
              ticketEmbed.setFooter(`© 2017-2022 Сообщество fw-rebirth.com`)
            } else {
